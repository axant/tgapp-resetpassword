...
from resetpassword.lib import forms
resetpassword_form = forms.ResetPasswordForm()
...
def configure_app(using):
    ...
    app_cfg['resetpassword.email_sender'] = 'reg@email.it' 
